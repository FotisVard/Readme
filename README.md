...
graph TD
    subgraph Hardware
       Muon goes through the detector--> Charge Detected on Both Scintillators --> MM["Micromegas"] Collects Data --> ADC [Analog to Digital Cards] --> FEC [Front-End Cards] --> DAQ["Raw DAQ Data"]
    end
